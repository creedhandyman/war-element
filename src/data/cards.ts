...
export const CARDS: CardDef[] = [
  ...
  },
  {
    ...
    shields: 0,
    keywords: {},
    // Ember Sting: a landed basic leaves BURN 2 for 2 rounds.
    passiveNames: { onHitStatus: "Ember Sting" },
    onHitStatus: { kind: "BURN", duration: 2, power: 2 },
  },
  {
    id: "pyro_nitro",
  ...
  },
  {
    ...
    shields: 3,
    keywords: {},
    // Coral Growth: every hit it takes calcifies another shield (caps at 6).
    passiveNames: { shieldPerHitTaken: "Coral Growth" },
    shieldPerHitTaken: { shields: 1, maxShields: 6 },
  },
  {
    id: "aqua_icewall",
  ...
  },
  {
    ...
    shields: 3,
    keywords: {},
    // Supernova: erupt in light — 6 DMG and BLIND to every opponent in range.
    special: {
      name: "Supernova",
      cost: 4,
      handler: "barrage",
      params: { dmg: 6, targets: 99, statusKind: "BLIND", statusDuration: 2 },
      targetSide: "enemy",
      ranged: true,
      text: "Deal 6 DMG and BLIND all opponents in range for 2 rounds.",
    },
  },
  {
    id: "dawn_war_rider",
    ...
    shields: 0,
    keywords: {},
    // Cavalry Charge: a basic struck while faster than its mark lands harder.
    passiveNames: { highSpeedImpact: "Cavalry Charge" },
    highSpeedImpact: true,
  },
  {
    id: "gale_stormfang",
