...
export const ELEMENT_AURA: Record<Element, AuraDef> = {
  LEAF: { name: "Photosynthesis", desc: "End of round, LEAF cards heal +2 HP, and gain +1 shield (max 3) if they were hit that round. Crowd-control wears off a round faster (Wildfire Resilience)." },
  PYRO: { name: "Scorch", desc: "Basic attacks apply BURN, stacking up to BURN 5 on the same target. Crowd-control wears off a round faster (Wildfire Resilience)." },
