...
export function App() {
  ...
  // The full deck builder, opened on the CAMPAIGN collection rather than the
  // custom-deck sandbox. Story Mode had its own thin editor; this is the good one.
  const [storyBuilder, setStoryBuilder] = useState(false);
  // Build to the largest ceiling the campaign currently allows, so one trip to
  // the builder can produce both the 18-card road team and the set-piece team.
