...
- **Special · Night Spear** (1◆) — Deal 8 DMG (4 CRIT), piercing shields, ROOT the target for 3 rounds, and MUTE it for 1 round.
- **Passives**
...
- **Stats** — DMG 4 · HP 11 · Shields 2 · SP 7 · Budget 26 vs 25 (+1)
- **Tribe** — Dragon
...
- **Passives**
  - Volcanic Charge — On a kill: +2 DMG · 3 to all enemies.
...
- **Tribe** — SeaC, Liquid
- **Special · Wave Crash** (2◆) — Deal 4 DMG to all opponents in the row directly ahead.
- **Passives**
  - On a kill: +3 max HP.
...
- **Tribe** — Ice
- **Special · Ice Crash Claw** (2◆) — Deal 3 DMG × 2 and FREEZE the target for 2 rounds.
- **Passives**
...
- **Special · Crowned** (3◆) — Gain +5 DMG, +5 HP, +5 SP permanently. 3-round cooldown.
- **Passives**
...
- **Special · 100,000°** (2◆) — Your next basic attack deals +14 DMG (PEN).
- **Passives**
  - On summon: deal 7 DMG to one enemy.
  - Dawning Assault — On death, deals 3 damage back to its killer.
...
- **Tribe** — Avian, Wolf
- **Keywords** — FLYING
- **Special · Rampage** (2◆) — Gain +1 DMG for 3 rounds.
- **Passives**
  - Totem Spirit — Aura: while it lives, allied basic attacks also clip one extra adjacent target for full damage.
...
- **Special · Spiraling Windrow** (2◆) — Deal 5 DMG bouncing between opponents within 1 space of each other.
- **Passives**
...
- **Stats** — DMG 3 ×2 · HP 5 · Shields 0 · SP 4 · Budget 15 vs 15 (on)
- **Special** — none
- **Passives**
...
- **Stats** — DMG 3 ×2 · HP 5 · Shields 0 · SP 14 · Budget 25 vs 25 (on)
- **Keywords** — FLYING
- **Special** — none
- **Passives**
...
- **Stats** — DMG 2 · HP 16 · Shields 3 · SP 1 · Budget 25 vs 25 (on)
- **Keywords** — BLOCK
- **Special** — none
- **Passives**
  - BLOCK 1: every incoming hit is reduced by 1 — before shields, and even against PEN.
...
- **Special · Storm Swarm** (3◆) — Raise one Beebot per ELECTRIFIED opponent, then every Beebot on the board stings.
- **Passives**
...
- **Special** — none
- **Passives**
  - Talent (free · once per game) — Bird Bomb: Once per game, free: create 3 Crows.
...
- **Special** — none
- **Passives**
  - Spook — Basic hits first hit: apply FRIGHTEN for 1 round.
- **Found at** — Dusk · The Weeping Chapel
- **Lore** — _(none yet)_
...
- **Tribe** — Cavernous
- **Special · Drilling Quake** (5◆) — Tear off 5 HP to sinkhole all opponents in range — DOT 3, −5 SP, −50% accuracy for 3 rounds — then slip into STEALTH. 3-round cooldown.
- **Passives**
